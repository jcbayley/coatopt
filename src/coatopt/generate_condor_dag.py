...
arguments = --project {project_path} run python -m coatopt.run --config {config_basename} --run-name {base_run_name}_$(run_id) --seed $(seed){comparison_flag}
...
# File transfer - always transfer input files
