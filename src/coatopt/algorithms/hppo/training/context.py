...
class TrainingContext:
    ...
    def add_episode_metrics(self, episode: int, metrics: Dict[str, Any]) -> None:
        ...
        self.training_metrics = pd.concat([self.training_metrics, new_row], ignore_index=True)
    ...
    def update_pareto_data(self, rewards: np.ndarray, values: np.ndarray, 
                          states: Optional[np.ndarray] = None) -> None:
    ...
    def add_constraint_entry(self, episode: int, phase: int, target_objective: str,
                           constraints: Dict[str, Any], reward_bounds: Dict[str, Any]) -> None:
