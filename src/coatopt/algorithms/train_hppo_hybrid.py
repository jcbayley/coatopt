...
This prevents the local minima problem of multi-agent (small separate networks getting stuck)
while maintaining better exploration than pure sequential (multiple constraint levels explored).
