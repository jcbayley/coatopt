...
class TestBaseCoatingEnvironment:
    ...
    def test_extract_parameter_names(self, basic_config, sample_materials):
        ...
        basic_config.data.optimise_parameters = [
            "reflectivity:max",
            "thermal_noise:min",
        ]

        env = BaseCoatingEnvironment(config=basic_config, materials=sample_materials)
    ...
    def test_objective_bounds_configuration(self, basic_config, sample_materials):
        ...
        bounds = {"reflectivity": [0.9, 1.0], "thermal_noise": [1e-22, 1e-19]}
    ...
    @patch(
        "coatopt.environments.core.base_environment.BaseCoatingEnvironment._setup_common_attributes"
    )
    def test_setup_common_attributes_called(
        self, mock_setup, basic_config, sample_materials
    ):
...
class TestBaseCoatingEnvironmentParameterExtraction:
    ...
    def test_extract_parameter_names_no_direction(self, sample_materials):
        ...
        result = env._extract_parameter_names(
            ["reflectivity", "thermal_noise", "absorption"]
        )
    ...
    def test_extract_parameter_names_with_directions(self, sample_materials):
        ...
        result = env._extract_parameter_names(
            ["reflectivity:max", "thermal_noise:min", "absorption:min", "thickness"]
        )
    ...
    def test_extract_parameter_names_mixed_cases(self, sample_materials):
        ...
        result = env._extract_parameter_names(
            ["reflectivity:max", "thermal_noise", "absorption:min"]
        )
        expected = ["reflectivity", "thermal_noise", "absorption"]
        assert result == expected
