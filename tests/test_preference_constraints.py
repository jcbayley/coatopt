...
from coatopt.environments.reward_functions.reward_addons import apply_preference_constraints_addon
...
class TestPreferenceConstrainedTracker:
    ...
    def test_phase2_info_constraint_progression(self, basic_tracker):
        ...
        phase2_info1 = basic_tracker.get_training_phase_info(200)  # First constraint step
        phase2_info2 = basic_tracker.get_training_phase_info(250)  # Second constraint step
    ...
    def test_constraint_margin_application(self):
        ...
        tracker = PreferenceConstrainedTracker(
            ...
            constraint_margin=0.2  # 20% margin
        )
...
class TestPreferenceConstraintsAddon:
    ...
    def test_phase1_no_constraints(self, mock_pc_tracker, basic_phase_info):
        ...
        updated_total, updated_rewards = apply_preference_constraints_addon(
            total_reward, rewards, vals, env, optimise_parameters,
            pc_tracker=mock_pc_tracker, phase_info=basic_phase_info
        )
    ...
    def test_phase2_with_constraints(self, mock_pc_tracker, phase2_info):
        ...
        updated_total, updated_rewards = apply_preference_constraints_addon(
            total_reward, rewards, vals, env, optimise_parameters,
            pc_tracker=mock_pc_tracker, phase_info=phase2_info
        )
    ...
    def test_missing_pc_tracker_raises_error(self):
        ...
        with pytest.raises(Exception, match="PreferenceConstrainedTracker and phase_info must be provided"):
    ...
    def test_missing_phase_info_raises_error(self, mock_pc_tracker):
        ...
        with pytest.raises(Exception, match="PreferenceConstrainedTracker and phase_info must be provided"):
            apply_preference_constraints_addon(
                0.8, {}, {}, Mock(), ['obj1'], pc_tracker=mock_pc_tracker, phase_info=None
            )
    ...
    def test_phase2_no_constraints(self, mock_pc_tracker):
        ...
        updated_total, updated_rewards = apply_preference_constraints_addon(
            0.8, {'obj1': 0.9}, {}, Mock(), ['obj1'],
            pc_tracker=mock_pc_tracker, phase_info=phase_info
        )
...
class TestPreferenceConstraintsIntegration:
    ...
    def test_addon_with_real_tracker(self):
        ...
        updated_total, updated_rewards = apply_preference_constraints_addon(
            0.7, {'obj1': 0.8, 'obj2': 0.6}, {}, Mock(), ['obj1', 'obj2'],
            pc_tracker=tracker, phase_info=phase1_info
        )
